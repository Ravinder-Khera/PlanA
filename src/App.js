    ...
    if (isLoggedIn) {
      try {
        ...
        if (response.res) {
          ...
          sixMonthsAgoPlusThirtyDays.setMonth(
            sixMonthsAgoPlusThirtyDays.getMonth() + 6
          );
          sixMonthsAgoPlusThirtyDays.setDate(
            sixMonthsAgoPlusThirtyDays.getDate() - 30
          );

          const fiveDaysBeforeSixMonths = new Date(passwordLastChangedDate);
          fiveDaysBeforeSixMonths.setMonth(
            fiveDaysBeforeSixMonths.getMonth() + 6
          );
          fiveDaysBeforeSixMonths.setDate(
            fiveDaysBeforeSixMonths.getDate() - 5
          );
            ...
            <nav className="navbar navbar-expand-lg bg-transparent w-100">
              <div className="container-fluid navContainer  p-0">
                ...
                >
                  ...
                  >
                    <div className="d-flex align-items-center navMenuDiv justify-content-between">
                      {isLoggedIn && (
                        <Link
                          className="d-flex"
                        ...
                        >
                          ...
                          >
                            {userImg &&
                            userImg !== "default-profile-pic.jpg" ? (
                              <img
                                className="img-fluid"
                                alt={userImg}
                                src={
                                  process.env
                                    .REACT_APP_USER_API_CLOUD_IMG_PATH + userImg
                                }
                              />
                            ) : (
                              <User />
